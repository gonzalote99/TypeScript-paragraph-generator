...
function App(): JSX.Element {
  ...
  return(
    <section className='section-center w-90vw mx-auto max-w-40-rem mt-20 text-center '>
    <h3 className='uppercase'>lorem ipsum text</h3>
      ...
      <label className='text-lg' htmlFor='amount' >paragraphs: </label>
        <input className='px-1 py-2 w-16 rounded-lg border-none text-lg text-black' type='number' name='amount' id='amount' value={count} onChange={(e) => setCount(parseInt(e.target.value, 10))}
          />
